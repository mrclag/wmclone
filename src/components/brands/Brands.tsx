      ...
      <div className="categories-nav">
        <div className="wrapper">
          <div className="categories-buttons">
            <CategoryButton selected={true} onClick={()=>setCategory('discover')} className="category">Discover</CategoryButton>
            <CategoryButton onClick={()=>setCategory('flower')} className="category">Flower</CategoryButton>
            <CategoryButton onClick={()=>setCategory('concentrates')} className="category">Concentrates</CategoryButton>
            <CategoryButton onClick={()=>setCategory('vapepens')} className="category">Vape pens</CategoryButton>
            <CategoryButton onClick={()=>setCategory('edibles')} className="category">Edibles</CategoryButton>
            <CategoryButton onClick={()=>setCategory('cbdthc')} className="category">CDB/THC</CategoryButton>
            <CategoryButton onClick={()=>setCategory('cbd')} className="category">CBD</CategoryButton>
            <CategoryButton onClick={()=>setCategory('allbrands')} className="category">All Brands</CategoryButton>
          </div>
        </div>
      </div>
      <div className="wrapper">
